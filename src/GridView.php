...
class GridView extends \yii\grid\GridView
{
    ...
    {
        $class = get_called_class();
        if (is_array(ArrayHelper::getValue(static::$_defaultColumns, $class))) {
    ...
    {
        $column = ArrayHelper::getValue(static::getDefaultColumns(), $name);
    ...
    protected function createDataColumn($text)
    {
        ...
        if (is_array($column)) {
            $column['attribute'] = ArrayHelper::getValue($column, 'attribute', $text);
